  ...
  return (
    <div className="mx-auto max-w-[1600px] space-y-5">
      <section className="flex flex-col gap-4 border-b border-border pb-5 md:flex-row md:items-end md:justify-between">
        <div><div className="tech-label">Sentinel / Triage</div><h1 className="mt-2 text-[22px] font-semibold tracking-[-0.025em]">Threat queue</h1><p className="mt-1 text-[12px] text-[var(--text-secondary)]">All active alerts generated by the seeded baseline.</p></div>
